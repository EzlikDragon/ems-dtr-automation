...
$servername = getenv('DB_SERVER') ?: 'localhost'; // Default to 'localhost' if no environment variable is set
$username = getenv('DB_USERNAME') ?: 'root';      // Default to 'root'
$password = getenv('DB_PASSWORD') ?: '';          // Default to an empty password
$dbname = getenv('DB_NAME') ?: 'if0_37881933_mch_emp';         // Default to 'mch_emp'
